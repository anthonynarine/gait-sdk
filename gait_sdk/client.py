...
- FastAPI-specific dependency logic belongs in: gait_sdk/fastapi/dependencies.py
...
async def get_claims(authorization: Optional[str]) -> Dict[str, Any]:
    ...
    FastAPI apps should use: gait_sdk.fastapi.dependencies.verify_token
