"""
gait_sdk.fastapi.dependencies — FastAPI Authentication Dependency
=========================================================================
...
Teaching Notes:
---------------
- Uses the shared async validator from `gait_sdk.client`.
...
async def verify_token(
    ...
    try:
        ...
        logger.error(f"gait_sdk misconfigured: {e}")
