...
class AuthConfigurationError(Exception):
    """Raised when gait_sdk is misconfigured (e.g. GAIT_TOKEN_VERIFIER=jwks
...
class InvalidApplicationCredentialError(APIException):
    ...
    the two identity concepts (see `gait_sdk.application`) must
...
class SecuritySignalRejected(APIException):
    ...
    Covers every content-rejection reason for `gait_sdk.security.
