# Filename: auth_integration/security.py
"""
auth_integration.security — Tenant Security Signal Client
====================================================================
...
# -----------------------------------------------------------------------------
logger = logging.getLogger("auth_integration.security")
    ...
    *,
    ...
    Args:
        signal_type: Which approved signal this is (e.g.
            `auth_integration.security.APPLICATION_SELF_CHECK`). Gait
