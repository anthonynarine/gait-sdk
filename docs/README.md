...
| Doc | Read it when |
|---|---|
| [CONCEPTS.md](CONCEPTS.md) | You're new to tokens and identity: plain-language explanations with diagrams |
| [../examples/](../examples/) | You want to see it working in five minutes, with no account |
...
| [TROUBLESHOOTING.md](TROUBLESHOOTING.md) | You're looking at an error message and want to know what it means |
